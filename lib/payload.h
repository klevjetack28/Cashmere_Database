...
int payload_encode_piece_type_rows(char *payload, PieceType *piece_type_rows, int count);
...
int payload_encode_brand_rows(char *payload, Brand *brand_rows, int count);
...
int payload_encode_color_family_rows(char *payload, ColorFamily *color_family_rows, int count);
...
int payload_encode_color_rows(char *payload, Color *color_rows, int count);
...
int payload_encode_neckline_rows(char *payload, Neckline *neckline_rows, int count);
...
int payload_encode_sleeves_rows(char *payload, Sleeves *sleeves_rows, int count);
...
int payload_encode_type_rows(char *payload, Type *type_rows, int count);
...
int payload_encode_condition_rows(char *payload, Condition *condition_rows, int count);
...
int payload_encode_size_rows(char *payload, Size *size_rows, int count);
